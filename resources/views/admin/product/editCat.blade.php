        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open([
                            'url' => route('admin.product.updateCat', $cat->id),
                            'method' => 'POST',
                            'files' => true,
                        ]) !!}
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('slug', $cat->slug, ['class' => 'form-control', 'id' => 'convert_slug']) !!}
                        </div>
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                @foreach ($cat_products as $cat_product)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('delete_catproduct', $cat_product->id) }}"
