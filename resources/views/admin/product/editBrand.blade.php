        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open([
                            'url' => route('admin.product.updateBrand', $brand_product->id),
                            'method' => 'POST',
                            'files' => true,
                        ]) !!}
                        <div class="form-group">
                            {!! Form::label('name', 'Tên thương hiệu') !!}
                            {!! Form::text('name',  $brand_product->name , ['class' => 'form-control', 'id' => 'slug', 'onkeyup' => 'ChangeToSlug()']) !!}
                            @error('name')
                                ...
                                @foreach ($brands as $brand)
                                    ...
                                    @endphp
                                     <tr>
                                        ...
                                        <td>{{ $brand->name }}</td>
                                        <td>
                                            <a href="{{ route('admin.product.editBrand', $brand->id) }}" class="btn btn-success btn-sm rounded-0 text-white"
                                                type="button" data-toggle="tooltip" data-placement="top" title="Edit">
                                                <i class="fa fa-edit"></i></a>
                                            <a href="{{ route('admin.product.deleteBrand', $brand->id) }}" class="btn btn-danger btn-sm rounded-0 text-white"
